  ...
  private getDefaultMenuData(): MenuItem[] {
    return [
      ...
      },
      {
        ...
        id: 80,
        idParent: 2,
        name: 'Conocé nuestros productos',
        titleShow: 'Nuestros productos',
        icon: 'faLeaf',
        link: '/products',
        orderby: 1,
        status: 1,
      ...
      },
      {
        ...
        titleShow: 'Láminas de protección solar',
        icon: 'faLeaf',
        link: '/product/solar-protection',
        orderby: 1,
        status: 1,
        menuArguments: [],
        usersMenu: true,
      ...
      },
      {
        ...
        idParent: 2,
        name: 'decorative',
        titleShow: 'Láminas decorativas',
        icon: 'faShieldAlt',
        link: '/product/decorative',
        orderby: 4,
        status: 1,
        menuArguments: [],
        usersMenu: true,
