      ...
      const mockDetails: any = {
        'solar-protection': {
          product: {
            ...
            shortDescription:
              'Soluciones para reducir el calor, proteger contra rayos UV y mejorar la eficiencia energética.',
            longDescription: [
            ...
            features: [
              {
                ...
                description: 'Hasta 85% menos calor.',
              },
              {
                icon: 'fas fa-bolt',
                title: 'Eficiencia Energética',
                description: 'Menos consumo de aire acondicionado.',
              },
            ],
            specifications: [
            ...
            types: [
              {
                ...
                description:
                  'Las láminas solares espejadas en tono plata son una solución eficaz para reducir el calor que ingresa a través de los cristales, mejorando el confort en los ambientes y disminuyendo significativamente el gasto en refrigeración. Acabado reflectante, brinda privacidad y protege interiores.',
                specifications: [
                  { property: 'Protección contra rayos UV', value: '99%' },
                  {
                    property: 'Reducción de rayos infrarrojos (IR)',
                    value: '82%',
                  },
                ...
                challenges: [
                  {
                    question:
                      '¿Las láminas espejadas afectan la visibilidad desde adentro?',
                    answer:
                      'No, permiten ver hacia afuera con claridad, pero desde afuera brindan privacidad.',
                  },
                  {
                    question:
                      '¿Se pueden instalar en cualquier tipo de vidrio?',
                    answer:
                      'Sí, son compatibles con la mayoría de los vidrios planos y templados.',
                  },
                  {
                    question: '¿Cuánto tiempo duran las láminas espejadas?',
                    answer:
                      'Tienen una vida útil de 8 a 12 años según el mantenimiento y exposición solar.',
                  },
                  {
                    question: '¿Requieren mantenimiento especial?',
                    answer:
                      'Solo limpieza con agua y jabón neutro, evitando productos abrasivos.',
                  },
                  {
                    question:
                      '¿Ayudan a reducir el consumo de aire acondicionado?',
                    answer:
                      'Sí, al disminuir el ingreso de calor, reducen la necesidad de climatización.',
                  },
                ],
              },
              {
                ...
                description:
                  'Las láminas solares nano cerámicas en tono negro son una solución avanzada y estética para mejorar el confort y la eficiencia energética en espacios con cristales. Acabado oscuro, protección contra calor y deslumbramiento solar.',
                specifications: [
                  { property: 'Protección contra rayos UV', value: '99%' },
                  {
                    property: 'Reducción de rayos infrarrojos (IR)',
                  ...
                  {
                    property: 'Tonalidades disponibles',
                    value: 'claro / intermedios / oscuros',
                  },
                ],
                ...
                challenges: [
                  {
                    question:
                      '¿Las láminas nano cerámicas se ven oscuras desde adentro?',
                    answer: 'No, ofrecen buena visibilidad y confort visual.',
                  },
                  {
                    question: '¿Protegen contra rayos UV y calor?',
                    answer:
                      'Sí, bloquean hasta el 99% de rayos UV y gran parte del calor solar.',
                  },
                  {
                    question: '¿Se pueden instalar en automóviles?',
                    answer:
                      'Sí, son aptas para uso arquitectónico y automotriz.',
                  },
                  {
                    question: '¿Cambian el color del vidrio?',
                    answer:
                      'Aportan un tono oscuro moderno, sin distorsionar la visión.',
                  },
                  {
                    question: '¿Son resistentes al rayado?',
                    answer:
                      'Tienen recubrimiento anti-rayas para mayor durabilidad.',
                  },
                ],
              },
              {
                ...
                description:
                  'Las láminas solares selectivas completamente transparentes son una solución ideal para quienes buscan mejorar la eficiencia energética sin alterar la estética original de los cristales. Mantienen la apariencia natural y la claridad.',
                specifications: [
                  { property: 'Protección contra rayos UV', value: '99%' },
                  {
                    property: 'Reducción de rayos infrarrojos (IR)',
                ...
                challenges: [
                  {
                    question:
                      '¿Las láminas selectivas alteran la estética del vidrio?',
                    answer:
                      'No, son completamente transparentes y mantienen la apariencia original.',
                  },
                  {
                    question: '¿Bloquean el calor sin oscurecer?',
                    answer:
                      'Sí, filtran el calor y los rayos UV sin modificar la claridad.',
                  },
                  {
                    question: '¿Son recomendadas para vitrinas comerciales?',
                    answer:
                      'Sí, protegen productos del sol sin afectar la exhibición.',
                  },
                  {
                    question: '¿Requieren mantenimiento especial?',
                    answer: 'Solo limpieza suave, sin productos abrasivos.',
                  },
                  {
                    question: '¿Tienen garantía?',
                    answer:
                      'Sí, cuentan con garantía de fábrica de hasta 10 años.',
                  },
                ],
              },
            ],
        ...
        security: {
          product: {
            ...
            shortDescription:
              'Protección en caso de rotura y refuerzo de cristales.',
            longDescription: [
            ...
            features: [
              {
                ...
                title: 'Protección',
                description: 'Evita lesiones en caso de rotura.',
              },
              {
                icon: 'fas fa-sun',
                title: 'Protección UV',
                description: 'Protección UV 99%.',
              },
            ],
            specifications: [
            ...
            types: [
              {
                ...
                specifications: [
                  {
                    property: 'Grosor y disponibilidad',
                    value: '100 / 200 / 300 / 400 micrones',
                  },
                  {
                    property: 'Protección en caso de rotura',
                    value:
                      'Mantiene los fragmentos de vidrio adheridos a la lámina',
                  },
                  { property: 'Protección contra rayos UV', value: '99%' },
                  {
                    property: 'Impacto en la estética del cristal',
                    value: 'Transparente, sin cambio visible',
                  },
                  {
                    property: 'Resistencia de presión',
                    value:
                      '45.36 kg/cm² (100 micrones), 77 kg/cm² (200), 106 kg/cm² (300), 127 kg/cm² (400)',
                  },
                ],
                finish: 'Transparente',
                ...
                challenges: [
                  {
                    question:
                      '¿Las láminas de seguridad afectan la transparencia del vidrio?',
                    answer: 'No, son invisibles y no alteran la estética.',
                  },
                  {
                    question: '¿Qué pasa si el vidrio se rompe?',
                    answer:
                      'La lámina mantiene los fragmentos unidos, evitando lesiones.',
                  },
                  {
                    question: '¿Son aptas para lugares públicos?',
                    answer:
                      'Sí, son ideales para escuelas, hospitales y oficinas.',
                  },
                  {
                    question: '¿Protegen contra rayos UV?',
                    answer: 'Sí, bloquean hasta el 99% de rayos UV.',
                  },
                  {
                    question: '¿Cuánto duran instaladas?',
                    answer: 'Tienen una vida útil de 8 a 12 años.',
                  },
                ],
              },
              {
                ...
                description:
                  'Lámina de seguridad de 100 micrones con tonalidad, combina protección física y control solar. Refuerza cristales, reduce temperatura y mejora eficiencia energética. Ofrece privacidad y estética moderna.',
                specifications: [
                  { property: 'Protección contra rayos UV', value: '99%' },
                  {
                    property: 'Reducción de rayos infrarrojos (IR)',
                ...
                challenges: [
                  {
                    question: '¿La lámina de color reduce la visibilidad?',
                    answer:
                      'Ofrece privacidad sin comprometer la visión desde adentro.',
                  },
                  {
                    question: '¿Combina protección física y solar?',
                    answer:
                      'Sí, refuerza el vidrio y reduce el ingreso de calor.',
                  },
                  {
                    question: '¿Se puede instalar en cualquier ventana?',
                    answer:
                      'Sí, es compatible con la mayoría de los cristales.',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    answer: 'Sí, cuenta con garantía de fábrica.',
                  },
                ],
              },
            ],
            ...
            features: [
              {
                ...
                title: 'Privacidad',
                description: 'Sin pérdida de luz.',
              },
              {
                icon: 'fas fa-palette',
                title: 'Variedad de colores',
                description: 'Disponible en blanco y gris.',
              },
            ],
            specifications: [
              {
                property: 'Colores disponibles',
                value: 'Blanco, gris, vinilos de color',
              },
            ...
            types: [
              {
                ...
                specifications: [
                  {
                    property: 'Transmisión de luz',
                    value: 'Alta, permite la entrada de luz natural',
                  },
                  {
                    property: 'Privacidad',
                    value: 'Alta, evita la visión clara desde ambos lados',
                  },
                  {
                    property: 'Disponibilidad de colores',
                    value: 'Blanco, grises, otros tonos neutros',
                  },
                  { property: 'Acabado', value: 'Esmerilado, mate y elegante' },
                  {
                    property: 'Mantenimiento',
                    value: 'Fácil de limpiar y duradero',
                  },
                ],
                finish: 'Esmerilado',
        ...
        'solar-plata': {
          product: {
            ...
            shortDescription:
              'Lámina reflectante que reduce el calor, protege contra rayos UV e IR, y brinda privacidad.',
            longDescription: [
            ...
            features: [
              {
                ...
                description: 'Bloquea hasta 74% de energía solar.',
              },
              {
                icon: 'fas fa-shield-alt',
                title: 'Protección UV',
              ...
              },
              {
                ...
                title: 'Protección IR',
                description: 'Protección IR 82%.',
              },
              {
                icon: 'fas fa-eye-slash',
                title: 'Privacidad',
                description:
                  'Visión hacia el exterior, privacidad desde fuera.',
              },
            ],
            specifications: [
              { property: 'Protección UV', value: '99%' },
            ...
            relatedProducts: [
              { name: 'Solar Espejada Bronce', link: '/product/solar-bronce' },
              {
                ...
                link: '/product/seguridad-100',
              },
            ],
            metaTitle: 'Solar Espejada Plata - Glazing™',
            metaDescription:
              'Lámina reflectante para máxima protección solar y privacidad.',
            keywords: [
              'solar',
              'espejada',
              'plata',
          ...
          related: [
            {
              id: 'solar-bronce',
              name: 'Solar Espejada Bronce',
              image: '/assets/images/products/solar-bronce.jpg',
              shortDescription:
                'Bloquea energía solar y rayos UV, acabado bronce para mayor confort.',
            },
            {
              id: 'seguridad-100',
              name: 'Seguridad 100 micrones',
              image: '/assets/images/products/seguridad-100.jpg',
              shortDescription:
                'Refuerza cristales, mantiene unidos los fragmentos y protege contra UV.',
            },
          ],
        },
        'seguridad-100': {
          product: {
            ...
            name: 'Seguridad 100 micrones',
            shortDescription:
              'Lámina transparente que refuerza cristales y protege contra rayos UV.',
            longDescription: [
            ...
            metaDescription:
              'Lámina transparente para reforzar cristales y proteger contra rayos UV.',
            keywords: ['seguridad', 'protección', 'cristales', 'uv'],
            isActive: true,
            featured: false,
            createdAt: new Date(),
          ...
          related: [
            {
              ...
              image: '/assets/images/products/solar-plata.jpg',
              shortDescription:
                'Reduce el calor, protege UV y brinda privacidad con acabado reflectante.',
            },
          ],
        },
        'decorativa-esmerilada': {
          product: {
            ...
            shortDescription:
              'Lámina mate que brinda privacidad sin perder luz, disponible en varios colores.',
            longDescription: [
